            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div>
                            <label for="bio" class="block text-sm font-medium text-gray-700"> {{ __('Bio') }}
                            </label>
                            <div class="mt-1">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center">
                                <img src="{{ $user->image }}" class="h-12 w-12 object-cover rounded-full ltr:me-5 rtl:ms-5 border border-gray-300">
                                <input type="file" name="image" id="file_input" value="" class=" ms-2 w-full border border-gray-200 bg-gray-50 block focus:outline-none rounded-xl">

                                {{-- <input
                                    class="w-full border border-gray-200 bg-gray-50 block focus:outline-none rounded-xl hidden "
                                    name="image" id="file_input" type="file">
                                <x-button type="button"
                                    onclick="document.getElementById('file_input').click()">{{ __('Change photo') }}
                                </x-button> --}}
                            </div>
                            @error('image')
                                <div class="mt-2 text-sm text-red-600">{{ $message }}</div>
                        ...
                        <div>
                            <div class="flex items-start">
                                ...
                                <div class="ltr:me-3 rtl:ms-3 text-sm">
                                    <label for="private_account"
                                        class="font-medium text-gray-700 ms-2">{{ __('Private Account') }}</label>
                                </div>
                            </div>
                        </div>
